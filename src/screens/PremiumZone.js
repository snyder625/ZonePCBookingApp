...
const PremiumZone = ({ navigation }) => {
  ...
  return (
      ...
      <View style={styles.imageView} > 
        <Image source={require("../../assets/images/PremiumZone.png")} style={styles.imageStyle} />
      </View>
      <Text style={styles.textStyle} >Premium Zone</Text>
